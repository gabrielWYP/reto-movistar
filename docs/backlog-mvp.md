...
1. Trabajar primero tareas `P0` cuyo estado sea `READY`.
2. No iniciar una tarea si sus dependencias no están terminadas.
3. Incluir el ID en la rama, PR y evidencia de validación.
4. Actualizar el estado solo cuando se cumplan todos los criterios de aceptación.
...
| Gate | Resultado verificable | Tareas mínimas |
|---|---|---|
| G0 - Fundaciones | Repositorio instalable, contenedor saludable y contratos de colaboración. | FND-01..04, SEC-01 |
| G1 - Facturación | PxQ ficticio validado, aprobado y emitido mediante adaptador simulado. | DOM-01..03, DAT-01..02, BIL-01..04, APR-01, UX-01 |
| G2 - Cobranza/Recaudo | Mensaje de pago clasificado y conciliación propuesta con aprobación. | COL-01..02, REC-01..03, APR-02 |
| G3 - Demo integrada | Journey E2E, tablero, evaluaciones y despliegue repetible. | AI-01..02, BI-01, EVAL-01..02, OBS-01, DEMO-01, REL-01 |
...
| DOM-02 | P0 | Implementar transiciones y bloqueos del supervisor. | Técnico | DOM-01 | BACKLOG |
| DOM-03 | P0 | Registrar auditoría inmutable por transición. | Técnico | DOM-02 | BACKLOG |
| DAT-01 | P0 | Definir esquemas PxQ, factura, pago y evidencia. | Técnico + áreas funcionales | FND-01 | READY |
| DAT-02 | P0 | Crear dataset sintético del journey principal y excepciones. | Facturación + Cobranzas/Recaudo | DAT-01 | BACKLOG |
| BIL-01 | P0 | Documentar proceso y reglas PxQ. | Facturación | FND-01 | READY |
...
| BIL-04 | P0 | Ejecutar validaciones deterministas y excepciones. | Técnico + Facturación | BIL-03 | BACKLOG |
| APR-01 | P0 | Aprobar o rechazar la emisión con identidad y comentario. | Técnico + Facturación | DOM-03, BIL-04 | BACKLOG |
| INT-01 | P0 | Simular emisión idempotente de factura. | Técnico | APR-01 | BACKLOG |
| UX-01 | P0 | Mostrar caso, evidencia, excepciones y aprobación. | Técnico + Demo/Calidad | BIL-04, APR-01 | BACKLOG |
| COL-01 | P1 | Documentar mensajes e intenciones de cobranza. | Cobranzas/Recaudo | FND-01 | READY |
| COL-02 | P1 | Clasificar mensajes y extraer referencias de pago. | Técnico | DAT-02, COL-01 | BACKLOG |
| REC-01 | P1 | Modelar depósitos y conciliaciones. | Técnico + Cobranzas/Recaudo | DAT-01 | BACKLOG |
| REC-02 | P1 | Implementar matching determinista factura-pago. | Técnico | INT-01, REC-01 | BACKLOG |
| REC-03 | P1 | Explicar diferencias y enviar ambigüedades a revisión. | Técnico | REC-02 | BACKLOG |
| APR-02 | P1 | Confirmar aplicación del pago y cerrar el caso. | Técnico + Cobranzas/Recaudo | REC-03 | BACKLOG |
| AI-01 | P1 | Orquestar agentes mediante máquina de estados. | Técnico | DOM-02, BIL-04, COL-02, REC-03 | BACKLOG |
| AI-02 | P1 | Abstraer proveedor LLM y versionar prompts. | Técnico | FND-02 | BACKLOG |
| BI-01 | P1 | Calcular KPIs E2E y quiebres del caso. | Técnico + Demo/Calidad | APR-02 | BACKLOG |
...
| DEMO-01 | P1 | Preparar guion E2E y evidencias reproducibles. | Demo/Calidad | G1, G2, BI-01 | BACKLOG |
| REL-01 | P1 | Desplegar imagen inmutable y ejecutar smoke tests públicos. | Técnico | FND-03, DEMO-01 | BACKLOG |
