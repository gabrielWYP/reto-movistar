...
Variables principales: `SONIA_DATASET`, `SONIA_HOST`, `SONIA_PORT`, `SONIA_UPLOAD_ROOT`, `SONIA_MAX_UPLOAD_MB`, `SONIA_MAX_UNCOMPRESSED_MB`, `SONIA_DATASET_TTL_SECONDS`, `OPENCODE_KEY` y `SONIA_BILLING_MODEL`.
