...
Variables principales: `SONIA_DATASET`, `SONIA_HOST`, `SONIA_PORT`, `SONIA_MAX_UPLOAD_MB`, `SONIA_MAX_UNCOMPRESSED_MB`, `SONIA_DATASET_TTL_SECONDS`, `OPENAI_API_KEY` y `SONIA_BILLING_MODEL`.
