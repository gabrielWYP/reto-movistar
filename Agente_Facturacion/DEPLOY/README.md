...
La clave OpenCode Go es opcional y, si se usa, debe provenir de un Secret `billing-agent-opencode`. No se incluye Ingress: la plataforma debe exponer solo `billing-front`; `billing-back` permanece interno.
